...
const DetailRow = ({ label, value, color }) => (
    <div className="flex justify-between py-2 border-b border-gray-100 dark:border-gray-700">
        ...
        <span className={`text-sm font-semibold text-gray-900 dark:text-gray-100 ${color || ''}`}>{value}</span>
    </div>
);
...
const TransactionDetailModal = ({ isOpen, onClose, transaction }) => {
    ...
    return (
        ...
        >
            <div 
                className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-2xl w-full max-w-lg mx-4"
            ...
            >
                ...
                <div className="space-y-1">
                    ...
                    <div className="pt-4 mt-2">
                        <p className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Note:</p>
                        <p className="text-base text-gray-800 dark:text-gray-100 bg-gray-50 dark:bg-gray-700 p-3 rounded-lg border dark:border-gray-600">
